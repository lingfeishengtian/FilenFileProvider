...
class FilenProviderItem: NSObject, NSFileProviderItem {
    ...
    init(identifier: NSFileProviderItemIdentifier, metadata: [String : Data]) {
        self.identifier = identifier
        self.extendedAttributes = metadata
        
        // TODO: Search metadata for creation, modified, date, etc...
    }
